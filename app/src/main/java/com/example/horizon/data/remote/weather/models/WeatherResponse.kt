...
data class WeatherResponse(
    ...
    data class AdditionalInfo(
        ...
        @Json(name = "temp_max") val currentMaxTempAroundLocation: String, // Max observed temp around region
        @Json(name = "temp_min") val currentMinTempAroundLocation: String // Min observed temp around region
    )
